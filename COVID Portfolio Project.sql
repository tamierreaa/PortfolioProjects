...
-- Looking at countries with Highest infection rate compared to Population (v)
...
-- Showing the total cases, and total deaths per date
...
-- Showing the total cases and total death count for the world
